...
export default function StampConfirmationView({ landmark, onContinue }: StampConfirmationViewProps) {
  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-[#171713] flex flex-col items-center justify-center overflow-hidden z-50 p-5 text-white">
      {/* Texture overlays */}
      <div className="absolute inset-0 bg-radial-gradient(circle_at_2px_2px,rgba(255,225,109,0.05)_1px,transparent_0) [background-size:16px_16px] pointer-events-none opacity-30 z-0"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-[#013220]/20 to-[#171713] pointer-events-none z-0"></div>
      ...
      <main className="relative z-20 flex flex-col items-center justify-between w-full max-w-[390px] h-[85vh] py-8">
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full">
          <motion.div
            ...
            className="relative p-[6px] border-4 border-[#fcd400] rounded-full bg-[#fff8f5] shadow-[0_8px_32px_rgba(252,212,0,0.25)] mb-8 max-w-[210px]"
          >
            {/* Inner dashed ring */}
            <div className="border-2 border-dashed border-[#ffe16d] rounded-full p-6 flex flex-col items-center justify-center w-40 h-40 bg-white">
              <CheckCircle className="w-16 h-16 text-[#705d00] fill-[#ffe16d]" />
              <h2 className="font-serif text-2xl font-black text-[#001b0f] tracking-wide mt-2">
                STAMPED!
              </h2>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="text-center w-full max-w-xs bg-[#fff8f5]/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 shadow-xl flex flex-col items-center gap-3"
          >
