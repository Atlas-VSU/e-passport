    ...
    <div className="w-full h-screen bg-[#FDF9F0] flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 relative z-10 flex flex-col gap-4">
            ...
            {sortedLandmarks.map((lm, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative aspect-square rounded-2xl bg-[#004225]/5 flex flex-col items-center justify-center p-2 border border-gray-100 overflow-hidden"
                >
                  {matchedStamp ? (
                    <>
                      ...
                      <div
                        className="w-12 h-12 rounded-full border-2 border-[#CBA052] flex items-center justify-center relative bg-white shadow-sm z-10"
        ...
        <div className="w-full mt-auto flex flex-col gap-2.5 pb-2">
          {/* Primary: Download / View E-Passport */}
          <motion.button
            id="completion-download-passport-btn"
            onClick={onShowPassport}
            whileTap={{ scale: 0.97 }}
            className="w-full h-12 bg-[#004225] text-[#CBA052] font-mono text-xs uppercase tracking-widest font-extrabold rounded-2xl flex items-center justify-center gap-1.5 shadow-md hover:bg-[#00301a] active:scale-[0.98] transition-all relative overflow-hidden group border border-[#CBA052]/20"
          >
